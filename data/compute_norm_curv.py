...
if __name__ == '__main__':
    root = "./PointDA_data/shapenet"
    save_root = "./PointDA_data/shapenet_norm_curv_angle"
    ...
    for j in range(len(Shape)):
        ...
        print("curv shape ",curv.shape)
        print("norm shape ",norm.shape)
        print("norm_included_angle ",norm_included_angle.shape)
